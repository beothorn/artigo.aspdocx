...
function frase(){
  introducao = introducaoArray.getRandomElement();
  objeto = objetoArray.getRandomElement();
  acao = acaoArray.getRandomElement();
  sujeito = sujeitoArray.getRandomElement();
  return introducao+objeto+acao+sujeito;
}
  
function leroLero(quantidadeDeFrases) {
  var leroLeroReturn = "";
  while (quantidadeDeFrases-- > 0) {
    leroLeroReturn += frase()+" ";
  }
  return leroLeroReturn;
}
